...
class Tpl {
     ...
     * @param array $assign
     */
    public function view($tpl,$assign = array())
    {
        if(empty($tpl) && empty($assign)){
            return;
        }
        //注册变量
    ...
    public function __construct() {
        $this->_template = resource_path().'/tpl';
        //$this->_res_base = public_path();//默认相对路径，public
    }
    /**
     * 注册变量
     *
